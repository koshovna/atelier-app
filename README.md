...
![Добавить заказ](screenshots/add-order.png)
...
![Удаление заказа](screenshots/delete-client.png)
...
- Для корректной работы вводите фамилии точно и без пробелов.
- Все даты — в формате: YYYY-MM-DD.
- Если возникает ошибка подключения, убедитесь, что backend работает.

---

## Контакты

Разработала: Суслова Виолетта Владимировна  
Версия: 2.3  
